...
const QStringList Skyrim::QtGame::weapons = {QString::fromStdString("Iron Sword"), QString::fromStdString("Steel Sword"), QString::fromStdString("Diamond Sword"), QString::fromStdString("Daedra Sword")};

const QStringList Skyrim::QtGame::shields = {QString::fromStdString("Iron Shield"), QString::fromStdString("Marvel S.H.I.E.L.D.")};
